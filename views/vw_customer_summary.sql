-- ============================================================================
-- View: vw_customer_summary (PostgreSQL Version)
-- Grain: Customer Level (one row per customer_id)
-- Purpose: Consolidates order frequency, signup dates, and lifetime spend.
-- ============================================================================
...
SELECT 
    ...
    co.last_order_date,
    CASE 
        WHEN co.last_order_date IS NOT NULL THEN (SELECT max_date FROM anchor) - co.last_order_date
        ELSE NULL
